          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20,),
                  Center(child: Text(r"Seagate Portable 4TB External Hard Drive HDD – USB 3.0 for PC, Mac, Xbox, & PlayStation - 1-Year Rescue Service (STGX4000400)",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 15),)),
                  SizedBox(height: 20,),
                  Column(
                    children: [
                      Row(
