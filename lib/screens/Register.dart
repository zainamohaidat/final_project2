...
class RegSc extends StatefulWidget{
  @override
  State<StatefulWidget>createState(){
    return buildClass();
  }
}
class buildClass extends State<RegSc>{
    ...
    return Scaffold(
      ...
      SafeArea(
        child: SingleChildScrollView(
          child: Column(
              children: [
                Image.network("https://s1.aigei.com/src/img/png/94/947921bcc1684ec0ad3b29e88f61bce9.png?imageMogr2/auto-orient/thumbnail/!282x282r/gravity/Center/crop/282x282/quality/85/%7CimageView2/2/w/282&e=1735488000&token=P7S2Xpzfz11vAkASLTkfHN7Fw-oOZBecqeJaxypL:gQUVgthTkoC_JbdvmalthZO6Vq0=")
                  ...
                  child: Column(
                    children: [
                      TextFormField(
                        ...
                        decoration: decoration(txtLabel: "Email",txt: "Ahmad@gmaile.com"),
                      ),
                      SizedBox(height: 10,),
                      TextFormField(
                        ...
                        decoration: decoration(txtLabel: "password",txt: "as23%A#m"),
                      ...
                      TextFormField(
                        ...
                        decoration: decoration(txtLabel: "Confirm password",txt: "as23%A#m"),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          Text("Already have account ?",style: TextStyle(fontWeight :FontWeight.bold,fontSize: 15),),
