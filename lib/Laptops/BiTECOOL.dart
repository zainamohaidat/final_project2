...
class BiTECOOL extends StatefulWidget {
  const BiTECOOL({super.key});

  @override
  State<BiTECOOL> createState() => _BiTECOOLState();
}

class _BiTECOOLState extends State<BiTECOOL> {
  @override
        ...
        child: SafeArea(
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [
                  Image.network("https://m.media-amazon.com/images/I/71FuBQEb08L._AC_SX679_.jpg"),
                  SizedBox(height: 20,),
                  Center(child: Text(r'"15.6" Windows 11 Laptop, Intel Core i3-5005U, 16GB RAM, 512GB SSD, FHD IPS Display, 2.4G/5G WiFi, BT5.0, RJ45, Webcam, Long Battery Life - for Work, Study, and Entertainmene',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 15),)),
                  SizedBox(height: 20,),
                  Column(
                    children: [
                      Row(
                  ...
                  SizedBox(height: 10,),
                  Center(child: Text(r"$279.00",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 15))),
                  SizedBox(height: 5,),
